<?php
/* This is the Take 3 Induction page. 
...
if(isset($_POST['print'])){
    ...
    $pdf->SetXY(10,50);
    $pdf->SetFontSize(12);
    $pdf->Write(5,'Congratulations! You have completed the induction course for TAKE 3. ');
    $pdf->SetXY(70,60);
    $pdf->SetFontSize(12);
...
$SubmitMessage = "You have successfully completed Take 3 module.";
...
?>
<form action="/TrainingFiles/Warehouse/Take3.php" method="post">    
<div>
<div class="PageHeader"><h1>Take 3</h1></div>
...
<p class="mb-0"><strong>Purpose</strong></p>
    <p class="mb-0">The purpose of this on-line training is to ensure that all identified personnel that are
required to complete this training are aware of the importance and the requirements of
Take 3, which is a hazard identification and risk assessment approach to control High
Risk Off Standard Tasks.</p>

    <p class="mb-0">Take 3 stands for:</p>
    <p>
        <ul class="square">
                <li>1. Stop</li>
                <li>2. Think</li>
    ...
    <p class="mb-0"><strong>Objectives</strong></p>
     <p class="mb-0">This training will be provided for all identified employees such as supervisors and
workshop employees who supervise or must perform High Risk Off Standard Tasks in the
workplace.</p>

<p class="mb-0">This on-line training will explain the following:</p>
<p>
        <ul class="square">
                <li>What is a High Risk off Standard Task.</li>
                <li>How to assess the task.</li>
                <li>How to record your assessment.</li>
                <li>How to determine appropriate control measures.</li>
        </ul>
    </p>
</blockquote></div>

<div id="page2" style="<?php echo $style2; ?>"><input name="style2" type="hidden" value="<?php echo $style2 ?>"><blockquote>
<p class="mb-0"><h3><strong>Definitions:</strong></h3></p>
<p class="mb-0"><strong>What is a standard task?</strong></p>
<p class="mb-0">Standard Task — A task that has been assessed, planned and there is a formal process
established to follow — SOP, Corporate Procedures, Policies, Safety Rules.</p>
<p class="mb-0"><strong>What is an off standard task?</strong></p>
<p class="mb-0">Off Standard Task— a task where there is no formalised process, control identified or
documentation — Breakdowns, Unusual loads.</p>
<p class="mb-0"><strong>What is High Risk?</strong></p>
<p class="mb-0">High Risk — Hazards that are deemed to have the potential to cause serious personal
injury/death or significant property damage.</p>

</blockquote></div>

<div id="page3" style="<?php echo $style3; ?>"><input name="style3" type="hidden" value="<?php echo $style3 ?>"><blockquote>
<p class="mb-0"><strong>When is Take 3 Required?</strong></p>
<p class="mb-0">Take 3 is required:</p>
<p>
        <ul class="square">
                <li>Every time an employee is confronted with any High Risk Off Standard Tasks.</li>
        </ul>
    </p>
    <p class="mb-0"><strong>What is required?</strong></p>
    <p class="mb-0">Every employee needs to:</p>
<p>
        <ul class="square">
                <li>Stop, Think and Plan before the high risk task is undertaken.</li>
        </ul>
    </p>
    <p class="mb-0"><strong>Who is responsible?</strong></p>
<p>
        <ul class="square">
                <li>All trained individuals who are involved with the identified High Risk Off Standard Task
process.</li>
        </ul>
    </p>
</blockquote></div>
...
<blockquote>
    ...
    <p class="mb-0">What does Take 3 stand for?</p>

   <p>
        <ul>
                <li><input type="radio" name="rdoQ1" value='A'> A) Look, Listen and Act.</li>
                <li><input type="radio" name="rdoQ1" value='B'> B) Stop, think and plan.</li>
                <li><input type="radio" name="rdoQ1" value='C'> C) Assess, Review and tackle.</li>
                <li><input type="radio" name="rdoQ1" value='D'> D) Observe, document and action.</li>
        </ul>
    </p>
...
<p><strong>Question 2</strong></p>
    <p class="mb-0">Take 3 is a process that involves:</p>
   <p>
        <ul>
                <li><input type="radio" name="rdoQ2" value='A'> A) Safety Leadership Walks.</li>
                <li><input type="radio" name="rdoQ2" value='B'> B) Hazard Identification and Risk Assessment.</li>
                <li><input type="radio" name="rdoQ2" value='C'> C) Budgeting.</li>
...
<p><strong>Question 3</strong></p>
    <p class="mb-0">Take 3 is applied to what type of risk?</p>
   <p>
        <ul>
                <li><input type="radio" name="rdoQ3" value='A'> A) Low.</li>
                <li><input type="radio" name="rdoQ3" value='B'> B) Medium.</li>
                <li><input type="radio" name="rdoQ3" value='C'> C) High.</li>
                <li><input type="radio" name="rdoQ3" value='D'> D) High off Standard.</li>
        </ul>
    </p>
    <div style="text-align:center"><label class="error"><?php echo $errorMessage; ?></label></div>
</blockquote></div>
...
<p><strong>Question 4</strong></p>
    <p class="mb-0">An off standard task is which of the following?</p>
   <p>
        <ul>
                <li><input type="radio" name="rdoQ4" value='A'> A) No formalised process.</li>
                <li><input type="radio" name="rdoQ4" value='B'> B) No control identified or documented.</li>
                <li><input type="radio" name="rdoQ4" value='C'> C) Break downs, unusual loads.</li>
