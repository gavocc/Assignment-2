<?php
/* This is the Pedestrian Safety Induction page. 
...
if(isset($_POST['print'])){
    ...
    $pdf->SetXY(10,50);
    $pdf->SetFontSize(12);
    $pdf->Write(5,'Congratulations! You have completed the induction course for Pedestrian Safety. ');
    $pdf->SetXY(70,60);
    $pdf->SetFontSize(12);
...
$SubmitMessage = "You have successfully completed Pedestrian Safety module.";
...
?>
<form action="/TrainingFiles/Warehouse/PedestrianSafety.php" method="post">    
<div>
<div class="PageHeader"><h1>Pedestrian Safety</h1></div>
...
<p class="mb-0"><strong>Introduction</strong></p>
    <p class="mb-0">The interaction between pedestrians and mobile equipment (e.g. forklifts, Iso loaders and
trucks, etc) is one of the highest risks faced by employees in our Company. The risk of
serious injury to pedestrians from mobile equipment is something employees will face on
most days when walking within our warehouses and yards. Put simply, pedestrians and
mobile equipment do not mix. We therefore must ensure effective controls are in place to
safely manage this danger.</p>
<p class="mb-0">Forklifts are one of the most dangerous pieces of equipment found ¡n the workplace.
Almost half of all people injured by a forklift are pedestrians.</p>
<p class="mb-0"><strong>Most common types of incidents in industry
resulting in serious injuries and fatalities are:</strong></p>
    
    <p>
        <ul class="square">
                <li>Struck by the vehicle</li>
                <li>Struck by the load</li>
                <li>Pinned by the vehicle</li>
        </ul>
    </p>
...
<p class="mb-0">In a twenty year period from 1986 to 2006, 56 forklift-related workplace fatalities were
reported in one state (Victoria) alone.</p>
<p class="mb-0">Thirty of these involved pedestrians; 16 were hit by loads and 14 struck by a forklift
(WorkSafe, Victorian statistics 2006).</p>
<p class="mb-0">During 2005 — 2006 the most common cause of fatalities within the workplace was from
mobile plant and transport. Nationally, 54 of the 157 fatalities reported were a result of
interaction between people and mobile equipment. Throughout this timeframe, there were
also 16 deaths of pedestrian workers and bystanders struck by vehicles.</p>

</blockquote></div>

<div id="page3" style="<?php echo $style3; ?>"><input name="style3" type="hidden" value="<?php echo $style3 ?>"><blockquote>
<p class="mb-0"><h3><strong>Prevention</strong></h3></p>
<p class="mb-0"><strong>How can you prevent these incidents when travelling about the terminals and
yards in the company?</strong></p>
<p>
        <ul class="square">
                <li>Be Aware.</li>
                <li>Be Alert.</li>
    ...
    <p class="mb-0">Pedestrians must give way to mobile equipment on site (i.e. before stepping into the path of
mobile equipment); pedestrians should make eye contact with the driver and wait for hand
signals from the driver to proceed before walking behind, or in front of the vehicle.</p>

    <p class="mb-0">It is important to be aware that even when on a designated walkway you must walk
defensively and be aware of mobile equipment. Pedestrian walkways are not to be used as
meeting places. Be alert by not reading material or using mobile phones in high vehicle
traffic areas. If your phone rings, stand to one side with full view of all traffic situations.</p>
...
<blockquote>
    ...
    <p class="mb-0">Who must give way in the event of likely contact between the pedestrian and
mobile equipment?</p>

   <p>
        <ul>
                <li><input type="radio" name="rdoQ1" value='A'> A) The mobile equipment operator.</li>
                <li><input type="radio" name="rdoQ1" value='B'> B) The pedestrian.</li>
...
<p><strong>Question 2</strong></p>
    <p class="mb-0">How does good traffic management assist in separating pedestrians from
mobile equipment?</p>
   <p>
        <ul>
                <li><input type="radio" name="rdoQ2" value='A'> A) Driver Exclusion Zones.</li>
                <li><input type="radio" name="rdoQ2" value='B'> B) Restricted Access.</li>
                <li><input type="radio" name="rdoQ2" value='C'> C) Separation.</li>
...
<p><strong>Question 3</strong></p>
    <p class="mb-0">What coiour is a designated pedestrian walkway?</p>
   <p>
        <ul>
                <li><input type="radio" name="rdoQ3" value='A'> A) Red.</li>
                <li><input type="radio" name="rdoQ3" value='B'> B) White.</li>
                <li><input type="radio" name="rdoQ3" value='C'> C) Yellow.</li>
        </ul>
    </p>
    <div style="text-align:center"><label class="error"><?php echo $errorMessage; ?></label></div>
</blockquote></div>
...
<p><strong>Question 4</strong></p>
    <p class="mb-0">Can a driver/worker enter a loading area whilst a forklrt is loading /
unloading?</p>
   <p>
        <ul>
                <li><input type="radio" name="rdoQ4" value='A'> A) Yes.</li>
                <li><input type="radio" name="rdoQ4" value='B'> B) No.</li>
